...
DATA = Path("data/irrigation_enhanced_dataset.csv")
...
print("=" * 80)
print("DHURANDHAR IRRIGATION V2 MODEL BENCHMARK")
print("=" * 80)
...
for name, model in models.items():
    ...
    print(f"Balanced accuracy : {bal_acc * 100:.3f}%")
...
output = Path("results/model_benchmark_v2.csv")
